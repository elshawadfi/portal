...
<script>
    ...
    function appendCustomerAdmins() {
        ...
        $.each(customerAdmins, function(i, admin) {
            ...
            adminImage += '<div class = "staff_children_parent_child_div" ><img src="' + fetchUserAvatar(admin.staffid, admin.profile_image) + '" data-toggle="tooltip" data-original-title="' + fullname + '"/></div>'
            adminImage += '</div></div>'
